...
from models.component.models import TeamApplication, TeamComponentInfo, ComponentSourceInfo, ComponentEnvVar, \
...
class AppRestore(MarketApp):
    ...
    def _create_component(self, snap):
        # component
        component = TeamComponentInfo(**snap["service_base"])
        # component source
