...
from models.component.models import ComponentSourceInfo
from service.market_app.component import Component
from service.market_app.original_app import OriginalApp
from service.market_app.property_changes import get_component_template
...
class UpdateComponents(object):
    ...
    def _create_update_components(self, session):
        ...
        for cpt in components:
            ...
            if component_tmpl:
                cpt.set_changes(session, self.original_app.tenant_env, self.original_app.region, cpt_changes[cpt.component.service_id],
    ...
    def _update_component_source(self, component_source: ComponentSourceInfo, version, tmpl: map = None):
