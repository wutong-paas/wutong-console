...
@router.get("/teams/{team_name}/env/{env_id}/groups/{group_id}/shared/apps", response_model=Response, name="分享应用列表")
...
@router.get("/teams/{team_name}/env/{env_id}/events/{event_id}/log", response_model=Response,
            name="获取作用对象的event事件")
