...
from common.base_client_service import get_tenant_region_info, get_region_access_info, \
...
class RemoteComponentClient(ApiBaseHttpClient):
    ...
    def create_service(self, session, region, tenant_name, body):
        """创建组件"""
    ...
    def update_service_probec(self, session, region, tenant_name, service_alias, body):
        """更新组件探针信息"""
    ...
    def change_application_volumes(self, session, tenant_name, region_name, region_app_id):
