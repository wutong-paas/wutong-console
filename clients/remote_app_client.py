...
class RemoteAppClient(ApiBaseHttpClient):
    ...
    def install_app(self, session, region_name, tenant_env, region_app_id, data):
        ...
        url = url + "/v2/tenants/" + tenant_env.tenant_name + "/envs/" + tenant_env.env_name + "/apps/" + \
    ...
    def proxy(self, request, url, region, data_json, body, requests_args=None, method=None):
        """
