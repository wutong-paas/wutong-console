...
class Application(Base):
    ...
    tenant_name = Column(String(64), comment="团队名", nullable=False)
    env_name = Column(String(64), comment="环境名", nullable=False)
    project_name = Column(String(64), comment="项目名", nullable=True)
    group_name = Column(String(128), comment="组名", nullable=False)
    region_name = Column(String(64), comment="集群英文名", nullable=False)
    region_alias = Column(String(32), comment="集群中文名", nullable=False)
    ...
    app_code = Column(String(32), comment="应用标识", nullable=False, default='')
    k8s_app = Column(String(32), comment="集群内应用名称", nullable=False, default='')
